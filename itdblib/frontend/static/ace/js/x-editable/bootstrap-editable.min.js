...
(function (a) {
    a.extend(a.fn.editableform.Constructor.prototype, {
        initTemplate: function () {
            var load_temp = a.fn.editableform.template;
            if(this.options.type == 'image'){
                load_temp = '<div class="form-inline editableform"><div class="control-group"><div><div class="editable-input"></div><div class="editable-buttons"></div></div><div class="editable-error-block"></div></div></div>';
            }
            this.$form = a(load_temp);
